        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top"><?php echo lang('inicio'); ?></a>
                </div>
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href=<?php site_url(); ?>'registro'><?php echo lang('registrate'); ?></a>
                        </li>
                        <li>
                            <a href=<?php site_url(); ?>'login'><?php echo lang('iniciar'); ?></a>
                        </li>
